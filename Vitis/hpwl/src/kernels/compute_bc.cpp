...
// inputs are a+, a- and x coord values. each lane is for a net, so 8 nets are processed simultaneouslyvalues. each lane is for a net, so 8 nets are processed simultaneously
