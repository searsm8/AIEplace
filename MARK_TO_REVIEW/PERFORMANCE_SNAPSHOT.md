...
Ratio = markv1 GP best HPWL / XPlace **published** reference (post-DP for ISPD2005). markv1 is global placement only (no detailed placement), so ~1.0 is at-parity and <1.0 means markv1's GP HPWL is below XPlace's *legalized* number.
