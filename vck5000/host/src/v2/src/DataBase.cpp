...
DataBase::DataBase(fs::path design_dir) {
#ifdef DEBUG
...
//*/
//void DataBase::addFillers(float target_utilization)
//{
//    // find the smallest macro in the design to use as the filler cell
//    float min_area = std::numeric_limits<float>::max();
//    uint32_t smallest_component_index;
//
//    for(uint32_t i = 0; i < typeLib.size(); i++)
//    {
//        if(typeLib[i].getArea() < min_area) {
//          min_area = typeLib[i].getArea();
//          smallest_component_index = i;
//        }
//    }
//    auto filler_component = typeLib.at_index(smallest_component_index);
//
//    typeLib.emplace("filler", ComponentKind::Filler, filler_component.width, filler_component.height);
//
//    //filler_component = lipyeLib.back();
//
...
//
//    int fillers_needed = unfilled_area / filler_component.getArea();
//
...
//{
//// TODO: uncomment again and refactor for new datastructure
...
////    }
////    return total_area;
//  return 0.0; // remove after refactor
//}
//
...
////
////    return nan_count;
//  return 0; // remove after refactor
//}
//
...
//  if (m.hasClass() == 1) {
//    std::string cls = m.macroClass();
//    if(cls == "BLOCK") {
//      kind = ComponentKind::Macro;
//    } else if (cls == "CORE") {
//      kind = ComponentKind::LogicCell;
//    } else {
...
//// Create a new component and add it to the database
//{
//      //auto type_idx = typeLib.index_of(c.macro_name);
//      //components.emplace_back(type_idx, c.origin[0], c.origin[1], c.status);
//}
//
